...
def get_args_parser():
    ...
    # parser.add_argument('--source', choices=['self', 'ssd', 'roger_ssd'], default='self')
    ...
    # parser.add_argument('--dataset_json_path', type=str, help='dataset_json_path', required=False)
